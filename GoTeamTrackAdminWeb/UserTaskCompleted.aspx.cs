...
public partial class UserTaskCompleted : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
                ...
                filter = "UCode = '" + SessionManager.LoggedInUCode + "' AND Status = 'Completed'";

                dtTask.DefaultView.RowFilter = filter;

                dtTask.DefaultView.Sort = "Task";
                rptrCompletedTask.DataSource = dtTask;
                rptrCompletedTask.DataBind();
